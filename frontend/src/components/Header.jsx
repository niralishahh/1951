...
export default function Header() {
    ...
    return (
        <header>
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2 border-b relative">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <button 
                        ...
                        type="button" 
                        className="inline-flex items-center p-2 ml-1 text-sm text-black rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200" 
